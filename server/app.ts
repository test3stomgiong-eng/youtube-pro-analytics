...
import { fetchYouTubeChannelData, searchYouTubeChannels } from './youtube.js';
import { auditChannelWithGemini, askGeminiAboutChannel, analyzeHashtagCompetitorStrategy } from './gemini.js';
...
// In-memory persistent cache for history and favorites
